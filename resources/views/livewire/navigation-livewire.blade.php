    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-teal-700 lg:px-8">
      <div class="relative flex h-16 justify-between">
        ...
        <div class="relative z-10 flex items-center justify-between lg:space-x-8 lg:py-2">
            ...
            <div class="relative hidden lg:flex lg:max-w-xs lg:ml-auto">
              ...
              <div class="relative">
                ...
                <input id="search" name="search"
                  class="block w-full rounded-md border-2 border-transparent bg-gray-800 p-4 text-white py-1.5 pl-10 pr-3
                  placeholder:text-gray-500 focus:bg-white focus:text-gray-900 focus:border-gray-600
                  focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6
            ...
            <!-- Desktop Notifications and Profile Dropdown -->
            <div class="hidden lg:flex lg:items-center lg:ml-4">
              ...
              <div class="relative ml-4 flex-shrink-0" x-data="{ open: false }">
                <button @click="open = ! open" type="button" class="relative flex rounded-full bg-gray-800 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  <span class="absolute -inset-1.5"></span>
                ...
                <div x-show="open" @click.outside="open = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                  <a href="{{ route('login') }}" class="block px-4 py-2 text-sm bg-gray-800 text-white rounded-md hover:bg-gray-700 hover:text-white border border-transparent hover:border-white transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300 ease-in-out" role="menuitem" tabindex="-1" id="user-menu-item-0">Iniciar sesión</a>
                  <a href="{{ route('register') }}" class="block px-4 py-2 text-sm bg-gray-800 text-white rounded-md hover:bg-gray-700 hover:text-white border border-transparent hover:border-white transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300 ease-in-out" role="menuitem" tabindex="-1" id="user-menu-item-1">Registrarse</a>
                </div>
              </div>
            </div>
          </div>
