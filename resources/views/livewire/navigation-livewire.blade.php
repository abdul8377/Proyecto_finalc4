        ...
        <div class="bg-indigo-600 w-8 h-8 rounded-full flex justify-center items-center bg-opacity-50 absolute top-1 left-6">
          ...
          <div class="relative ml-4 flex-shrink-0 " x-data="{ open: false }">
            ...
            <div x-show="open" @click.outside="open = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-yellow-600" role="menuitem" tabindex="-1" id="user-menu-item-0">iniciar sesion</a>
              <a href="{{ route('register') }}" class="block px-4 py-2 text-sm text-yellow-600" role="menuitem" tabindex="-1" id="user-menu-item-1">Registrarse</a>
            </div>
          </div>
        </div>
      </div>
