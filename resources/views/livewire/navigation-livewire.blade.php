<header class="bg-white">
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-teal-700 lg:px-8">
        <div class="relative flex h-16 justify-between">
                ...
                <div class="w-full sm:max-w-xs">
                    ...
                    <div class="relative">
                        ...
                        <input id="search" name="search"
                            class="block w-full rounded-md border-0 bg-teal-500 py-1.5 pl-10 pr-3 text-yellow-300 placeholder:text-yellow-400 focus:bg-white focus:text-gray-900 focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6"
            ...
            <div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                <div x-on:click="open=!open" class="relative cursor-pointer">
                    ...
                    <div class="bg-indigo-600 w-8 h-8 rounded-full flex justify-center items-center bg-opacity-50 absolute top-1 left-6">
                        <p class="text-gray-300 text-xl font-bold"></p>
                    </div>
                </div>
            ...
            -->
                    <div x-show="open" @click.outside="open = false"
                        ...
                        <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-yellow-600" role="menuitem"
                            tabindex="-1" id="user-menu-item-0">iniciar sesion</a>
                        <a href="{{ route('register') }}" class="block px-4 py-2 text-sm text-yellow-600"
                            role="menuitem" tabindex="-1" id="user-menu-item-1">Registrarse</a>
                    </div>
                </div>
            </div>
        </div>
        <nav class="hidden lg:flex lg:space-x-8 lg:py-2" aria-label="Global">
            ...
            <a href="#"
                class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium">Team</a>
            <a href="#"
                class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium">Projects</a>
            <a href="#"
                class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium">Calendar</a>
        </nav>
    </div>
